        ...
        <main className="relative min-h-screen flex items-center justify-center px-6 py-24">
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-ganga-sandstone/30">
              ...
              >
                <h1 className="font-serif text-4xl text-nidra-indigo mb-2">Welcome Back</h1>
                <p className="text-nidra-indigo/60">Sign in to continue your journey</p>
              </motion.div>
              ...
              >
                ...
                <Link href="/signup" className="text-ganga-sandstone hover:underline">
                  Create one
                </Link>
              </motion.p>
            </div>
