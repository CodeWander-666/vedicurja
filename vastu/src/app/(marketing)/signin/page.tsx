          ...
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-prakash-gold/30">
              <div className="text-center mb-8">
                <h1 className="font-serif text-3xl text-nidra-indigo">Welcome Back</h1>
                <p className="text-nidra-indigo/60 text-sm mt-2">Sign in to your VedicUrja account</p>
              </div>
