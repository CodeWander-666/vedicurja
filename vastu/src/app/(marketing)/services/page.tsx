...
import ServiceCard3DEnhanced from '@/components/services/ServiceCard3DEnhanced';
import VideoPlaceholder from '@/components/services/VideoPlaceholder';
      ...
      <motion.div style={{ y }} className="container mx-auto px-6 relative z-10 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <MagneticButton className="bg-transparent border-2 border-prakash-gold text-nidra-indigo hover:bg-prakash-gold/10 px-8 py-4 rounded-full">
            <button onClick={() => document.getElementById('service-grid')?.scrollIntoView({ behavior: 'smooth' })}>
              Explore Services
            </button>
          </MagneticButton>
        </motion.div>
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <img src="/images/services/offline-consult.jpg" alt="In-person consultation" className="rounded-3xl shadow-2xl" />
          </div>
