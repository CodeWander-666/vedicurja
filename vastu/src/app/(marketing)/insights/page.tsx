      ...
      <SmoothScroll>
        <main className="relative z-10 pt-32 pb-20 min-h-screen bg-vastu-parchment">
          <div className="container mx-auto px-6">
            <h1 className="font-serif text-4xl text-center mb-8">Sacred Archives</h1><div className="grid md:grid-cols-3 gap-6"><div className="bg-white p-6 rounded-xl shadow"><h3 className="font-serif text-xl">Post Title</h3><p>Excerpt...</p></div></div>
          </div>
        </main>
        <Footer />
      </SmoothScroll>
