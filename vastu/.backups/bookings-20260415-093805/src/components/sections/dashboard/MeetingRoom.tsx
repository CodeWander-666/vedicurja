...
// Using CSS lock animation
 // You'll need to add a Lottie JSON
...
export default function MeetingRoom({
  ...
  useEffect(() => {
    const checkAccess = () => {
      ...
      // Meeting is unlocked if:
      // - status is 'scheduled' or 'completed' (for rejoining)
      // - within 10 minutes before start time
            ...
            {isUnlocked ? (
              ...
              <>
                <div className="w-40 h-40 mb-6">
                  <div className="lock-animation"><div className="lock-body"><div className="lock-shackle"></div></div></div>
                </div>
