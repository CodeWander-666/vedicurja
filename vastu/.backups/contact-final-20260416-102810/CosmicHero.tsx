...
import LuxuryHeroButton from '@/components/ui/LuxuryHeroButton';
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        >
          <LuxuryHeroButton href={heroData.button_link || '#'} variant="primary">
            {heroData.button_text}
          </LuxuryHeroButton>
          {heroData.secondary_button_text && heroData.secondary_button_link && (
            <LuxuryHeroButton href={heroData.secondary_button_link || '#'} variant="secondary">
